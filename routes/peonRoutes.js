...
const ctrl = require('../controllers/peonController');
...
router.get('/api', ctrl.listJson);                // GET /peons/api
router.get('/api/:id', ctrl.getJson);             // GET /peons/api/:id
...
// API endpoints (alternate convention: /api/peons)
